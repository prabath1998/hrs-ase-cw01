        ...
        <div class="grid md:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <div class="space-y-2"><a href="/hotels"
                        ...
                        href="/destinations"
                        class="block text-gray-300 hover:text-white transition-colors">Destinations</a><a href="/deals"
                        class="block text-gray-300 hover:text-white transition-colors">Special
                        Deals</a><a href="/about" class="block text-gray-300 hover:text-white transition-colors">About
                        Us</a></div>
            </div>
            <div>
                <h4 class="text-lg font-semibold mb-4">Support</h4>
                <div class="space-y-2"><a href="/help"
                        class="block text-gray-300 hover:text-white transition-colors">Help Center</a><a href="/contact"
                        class="block text-gray-300 hover:text-white transition-colors">Contact
            ...
            <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            class="lucide lucide-phone w-5 h-5 text-gray-400">
                            <path
                    ...
                    <div class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round"
                            class="lucide lucide-map-pin w-5 h-5 text-gray-400">
