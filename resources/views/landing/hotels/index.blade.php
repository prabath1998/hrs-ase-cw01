                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-right">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-1 font-semibold">{{ number_format(rand(40, 50) / 10, 1) }}</span>
                                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('hotels.show', ['hotel' => $hotel->id]) }}" class="px-4 py-2 bg-blue-600 border border-transparent rounded-md text-sm font-medium text-white hover:bg-blue-700">
                                {{ __('View Details') }}
                            </a>
                        </div>
                    </div>
