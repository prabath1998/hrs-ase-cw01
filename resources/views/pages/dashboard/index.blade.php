        ...
        <div x-data="{ tab: 'overview' }" class="space-y-6">
            <div class="grid w-full grid-cols-5 mb-4">
                ...
                <button :class="tab === 'favorites' ? 'bg-blue-100 text-blue-700' : 'bg-white text-gray-700'"
                    @click="tab='favorites'" class="py-2 px-4 border-b">Favorites</button>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded shadow">
                        ...
                        <form class="p-6 space-y-4">
                            ...
                            <div>
                                <label for="specialRequests" class="block text-sm font-medium">Special
                                    Requests</label>
                                <input id="specialRequests" class="border rounded px-3 py-2 w-full"
                                    value="High floor, ocean view" />
                            </div>
                            <div class="space-y-3">
                    ...
                    <div class="bg-white rounded shadow">
                        ...
                        <div class="p-6 space-y-4">
                            <div
                                class="text-center p-4 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-lg text-white">
                            ...
                            <button
                                class="bg-yellow-600 text-white px-4 py-2 rounded w-full flex items-center justify-center hover:bg-yellow-700">
        ...
        function dashboardPage() {
            return {
                ...
                reservations: [{
                        ...
                        roomImage: "{{ asset('images/hotel/1/83871748.jpg') }}",
                        hotelName: "Sunset Galle Fort",
                        checkIn: "2025-02-15",
                        checkOut: "2025-02-18",
                        guests: 2,
                        status: "confirmed",
                        total: 360,
                        nights: 3,
                        amenities: ["Executive Lounge", "Balcony", "Butler Service", "Private Terrace"],
                    },
                    {
                        id: "RES-002",
                        roomName: "Executive Suite",
                        roomImage: "{{ asset('images/hotel/grand-plaza-miami.jpg') }}",
                        hotelName: "Sunset Galle Fort",
                        checkIn: "2025-04-10",
                        checkOut: "2025-04-18",
                        guests: 2,
                ...
                billing: [{
                        id: "INV-001",
                        date: "2025-02-18",
                        description: "Standard Twin Room - 3 nights",
                        amount: 360,
                        status: "paid",
                    ...
                    },
                    {
                        id: "INV-002",
                        date: "2025-04-18",
                        description: "Executive Suite - 8 nights",
                        amount: 1348,
                        status: "paid",
                ...
                hotels: [{
                        ...
                        location: "Galle City, Galle (Old Town)",
                        image: "{{ asset('images/hotel/grand-plaza-miami.jpg') }}",
                        rating: 4.9,
                        price: 299,
                ...
                reviews: [{
                        ...
                        review: "The hotel exceeded all expectations. The staff was incredibly attentive, the room was spacious and beautifully appointed, and the ocean view was breathtaking. The spa services were world-class, and the dining options were excellent. I would definitely stay here again.",
                        date: "2024-01-15",
                        helpful: 12,
                    ...
                    },
                    {
                        ...
                        review: "Perfect location in the heart of the city. The room was clean and comfortable, though a bit smaller than expected. The staff was friendly and helpful. The business center was well-equipped for my work needs.",
                        date: "2023-12-20",
                        helpful: 8,
