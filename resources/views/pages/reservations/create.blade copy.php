...
@section('content')
    <div class="min-h-screen bg-gray-50">
        ...
        <!-- Main Content -->
        <main class="max-w-6xl mx-auto px-2 sm:px-6 lg:px-8 py-10" x-data="reservationForm()">
            ...
            <div class="flex flex-col lg:flex-row gap-10">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                        ...
                        <form @submit.prevent="submitForm" class="px-8 py-6">
                            ...
                            <div x-show="currentStep === 1" x-cloak>
                                ...
                                <div class="border rounded-xl overflow-hidden mb-7 bg-gray-50">
                                        ...
                                        <div class="p-5 md:w-2/3">
                                            <div class="flex justify-between items-start">
                                                <div>
                                                    ...
                                                    <p class="text-gray-500 text-xs mt-1">1 King Bed • City View • 45m²</p>
                                                    <div class="mt-2 flex items-center">
                                                        ...
                                                        <span class="ml-1 text-gray-500 text-xs">4.8 (120 reviews)</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        ...
                                        <input type="text" id="check-in-date"
                                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Number of Rooms</label>
                                        <select
                                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm"
                            ...
                            <div x-show="currentStep === 2" x-cloak>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <label for="first-name" class="block text-xs font-medium text-gray-700 mb-1">First
                                            Name</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                    ...
                                    <div>
                                        <label for="zip"
                                            class="block text-xs font-medium text-gray-700 mb-1">ZIP/Postal Code</label>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Special requests cannot be guaranteed but we will
                                ...
                                <div x-data="{ isChecked: paymentMethod === 'credit-card' }" x-show="paymentMethod === 'credit-card'" class="space-y-6">
                                    <div>
                                        <label for="card-holder"
                                            class="block text-xs font-medium text-gray-700 mb-1">Cardholder Name</label>
                                    ...
                                    <div>
                                        <label for="card-number" class="block text-xs font-medium text-gray-700 mb-1">Card
                                            Number</label>
                                        <div class="relative">
                                            <input type="text" id="card-number"
                                                class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm"
                                                placeholder="1234 5678 9012 3456" x-model="cardNumber" maxlength="19"
                                                x-on:input="formatCardNumber" :required="paymentMethod === 'credit-card'">
                                    ...
                                    <div class="grid grid-cols-2 gap-6">
                                        <div>
                                            <label for="expiry-date"
                                                class="block text-xs font-medium text-gray-700 mb-1">Expiry Date</label>
                                            <input type="text" id="expiry-date"
                                                class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm"
                                                placeholder="MM/YY" x-model="expiryDate" maxlength="5"
                                                x-on:input="formatExpiryDate" :required="paymentMethod === 'credit-card'">
                                        </div>
                                        <div>
                                            <label for="cvv"
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 text-xs">
                                            <label for="terms" class="font-medium text-gray-700">I agree to the <a
                                                    href="#" class="text-primary-600 hover:text-primary-500">Terms
                            ...
                            <div class="flex justify-between mt-10">
                                <button type="button"
                                    class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 text-sm"
                                    x-show="currentStep > 1" @click="prevStep">
                                    Previous
                                </button>
                                <div class="flex-1"></div>
                                <button type="button"
                                    class="px-4 py-2 border border-transparent rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 text-sm"
                                    x-show="currentStep < totalSteps" @click="nextStep">
                                    Next
                                </button>
                                <button type="submit"
                                    class="px-4 py-2 border border-transparent rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <!-- Booking Summary -->
                <div class="lg:w-5/12">
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 sticky top-6">
                        <div class="px-8 py-6 border-b">
                        ...
                        <div class="px-8 py-6">
                            <div class="flex justify-between mb-4">
                                <div>
                                    ...
                                    <p class="d-none text-xs text-gray-500">Miami, Florida</p>
                                </div>
                                <div class="flex items-center">
                            ...
                            <div class="border-t pt-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-xl text-blue-700">$<span x-text="calculateTotal()"></span></span>
                                </div>
        ...
        <div x-data="{ showModal: false }" x-show="showModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
            aria-labelledby="modal-title" role="dialog" aria-modal="true" x-show-confirmation.window="showModal = true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div x-show="showModal" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="bg-gray-50 px-6 py-4 sm:px-8 sm:flex sm:flex-row-reverse">
                        <a href="index.html"
                            class="w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:ml-3 sm:w-auto sm:text-xs">
                            Return to Home
                        </a>
                        <button type="button"
                            class="mt-3 w-full inline-flex justify-center rounded-lg border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-xs"
