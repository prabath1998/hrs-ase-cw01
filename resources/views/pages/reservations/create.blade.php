                                            ...
                                            @foreach ($optionalServices as $service)
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="service{{ $service->id }}"
                                                        class="ml-3 text-sm text-gray-700">{{ $service->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                            ...
                            <div x-show="currentStep === 2" x-cloak>
                                ...
                                <div class="mb-6">
                                    <label for="special-requests"
                                        class="block text-sm font-medium text-gray-700 mb-1">Special Requests
                                        (Optional)</label>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Special requests cannot be guaranteed but we will
                            ...
                            <div x-show="currentStep === 3" x-cloak>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-center">
                                            ...
                                            <label for="credit-card" class="ml-3 text-sm text-gray-700">Credit
                                                Card</label>
                                        </div>
                                        {{-- Pay after check in --}}
                                        <div class="flex items-center">
                                            ...
                                            <label for="offline-payment" class="ml-3 text-sm text-gray-700">Pay at
                                                check-in</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div x-show="paymentMethod === 'paypal'" class="bg-blue-50 p-4 rounded-md">
                                    <p class="text-sm text-blue-800">
                                        You will be redirected to PayPal to complete your payment after reviewing your
                                        reservation.
                                    </p>
                                </div>
                                        ...
                                        <template x-if="paymentMethod === 'paypal'">
                                            <div class="flex items-center">
                                                <svg class="h-5 w-8 mr-2" viewBox="0 0 36 24" fill="none"
                                                    ...
                                                    <path
                                                        d="M24.5 7.5C24.5 9.5 23 11 21 11H18.5L18 13.5H15L16.5 5H21C23 5 24.5 6 24.5 7.5Z"
                                                        fill="#003087" />
                                                    <path
                                                        d="M28 9.5C28 11.5 26.5 13 24.5 13H22L21.5 15.5H18.5L20 7H24.5C26.5 7 28 8 28 9.5Z"
                                                        fill="#0070E0" />
                                                </svg>
                                                <span>PayPal</span>
                                            </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <span class="font-medium">$<span x-text="roomBasePrice"></span> × <span
                            ...
                            <div class="mt-6 bg-green-50 p-4 rounded-md">
                                <div class="flex">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-green-800">Free cancellation until 24 hours
                                            before check-in</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="mt-4 bg-gray-50 p-4 rounded-md">
                                        <p class="text-sm font-medium text-gray-900">Reservation Number: <span
