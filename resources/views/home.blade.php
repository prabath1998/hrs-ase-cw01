            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <nav class="hidden md:flex space-x-6">
                        <a href="{{route('hotels.index')}}" class="text-gray-700 hover:text-blue-600 transition-colors">
                            Hotels
                        </a>
...
<div class="flex items-center space-x-3">
    @guest
        <!-- Guest: Modern Sign In and Register Buttons -->
    ...
    @else
        <!-- Logged-in User: Modern Avatar Dropdown -->
        <div x-data="{ open: false }" class="relative">
            ...
            <div x-show="open"
                ...
                <!-- User Info Header -->
                <div class="px-4 py-3 bg-gradient-to-r from-gray-50 to-gray-100/50 border-b border-gray-200/60">
                    <div class="flex items-center space-x-3">
                ...
                <div class="py-2">
                    <a href="/admin" class="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50/80 hover:text-gray-900 transition-all duration-150">
                ...
                <div class="border-t border-gray-200/60 py-2">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="group flex items-center w-full px-4 py-3 text-sm text-red-600 hover:bg-red-50/80 hover:text-red-700 transition-all duration-150">
        ...
        <div class="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
            ...
            <div class="bg-white text-gray-900 p-6 rounded-lg shadow-xl max-w-4xl mx-auto" x-data="{ showFilters: false }">
                <div class="grid md:grid-cols-5 gap-4">
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" placeholder="Destination, hotel name, or landmark" class="pl-10 w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2">Check-in</label>
                        <input type="text" id="check-in" placeholder="Add dates" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-2">Check-out</label>
                        <input type="text" id="check-out" placeholder="Add dates" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                ...
                <div class="flex justify-between items-center mt-6">
                    ...
                    <a href="hotels.html" class="px-8 py-2 bg-blue-600 border border-transparent rounded-md text-sm font-medium text-white hover:bg-blue-700 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="bg-yellow-500 text-yellow-900 px-2 py-1 rounded text-xs font-semibold">25% OFF</span>
                    </div>
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <button class="px-3 py-1 border border-white rounded-md text-white hover:bg-white hover:text-blue-600 transition-colors">
                            Learn More
                        </button>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="bg-yellow-500 text-yellow-900 px-2 py-1 rounded text-xs font-semibold">Free Night</span>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="bg-yellow-500 text-yellow-900 px-2 py-1 rounded text-xs font-semibold">20% OFF</span>
                    </div>
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 line-clamp-2">Luxury beachfront resort offering world-class amenities, stunning ocean views, and exceptional service in the heart of South Beach.</p>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 line-clamp-2">Stunning clifftop resort overlooking the Pacific Ocean, featuring world-class dining and spa facilities.</p>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4 line-clamp-2">Luxury mountain retreat offering ski-in/ski-out access, alpine spa, and breathtaking mountain views.</p>
            ...
            <div class="text-center mt-12">
                <a href="hotels.html" class="px-6 py-3 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 inline-flex items-center">
                    View All Hotels
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600">
                    Grow your business by joining the HotelHub network and offering our extensive inventory to your clients.
                </p>
            </div>

            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div>
                    <img src="https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80" alt="Partner Hotels" class="rounded-lg shadow-lg">
                </div>
                <div>
                    ...
                    <a href="partners.html" class="px-6 py-3 bg-blue-600 border border-transparent rounded-md text-base font-medium text-white hover:bg-blue-700">
                        Become a Partner
                    </a>
                </div>
            </div>
            ...
            <div class="mt-12 grid md:grid-cols-3 gap-8 text-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-blue-600 mx-auto mb-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-600 mx-auto mb-2" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-purple-600 mx-auto mb-2" viewBox="0 0 20 20" fill="currentColor">
    ...
    <section class="py-16 bg-blue-600 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="max-w-md mx-auto flex space-x-4">
                <input type="email" placeholder="Enter your email address" class="flex-1 px-4 py-2 rounded-md text-gray-900">
            ...
            <div class="grid md:grid-cols-5 gap-8">
                <div class="md:col-span-2">
                    ...
                    <p class="text-gray-300 mb-6 max-w-md">
                        Your trusted partner for finding and booking the perfect accommodations worldwide. Experience luxury,
