...
<body class="bg-white">
        ...
        <nav class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex items-center space-x-3">
                    <a href="{{ route('admin.login') }}" class="text-gray-700 hover:text-gold transition-colors px-4 py-2 rounded-lg hover:bg-gray-50">
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="text-gray-700 hover:text-gold transition-colors px-4 py-2 rounded-lg hover:bg-gray-50 border border-gray-300">
                        Register
                    </a>
                    <button class="bg-gold text-white px-6 py-2 rounded-lg hover:bg-gold-dark transition-colors">
                        Book Now
                    </button>
                </div>
                ...
                <div class="flex flex-col space-y-4">
                    ...
                    <div class="border-t border-gray-200 pt-4 mt-4">
                        <div class="flex flex-col space-y-3">
                            <button class="text-gray-700 hover:text-gold transition-colors px-4 py-2 rounded-lg hover:bg-gray-50 text-left">
                                Login
                            </button>
                            <button class="text-gray-700 hover:text-gold transition-colors px-4 py-2 rounded-lg hover:bg-gray-50 border border-gray-300 text-left">
                                Register
                            </button>
                            <button class="bg-gold text-white px-4 py-2 rounded-lg hover:bg-gold-dark transition-colors">
                                Book Now
                            </button>
                        </div>
                    </div>
    ...
    <!-- Hero Section -->
    <section id="home" class="relative h-screen bg-cover bg-center" style="background-image: url('/placeholder.svg?height=800&width=1200');">
                ...
                <div class="bg-white bg-opacity-95 rounded-lg p-6 md:p-8 text-gray-800 max-w-4xl mx-auto">
                    ...
                    <form class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        <div class="lg:col-span-1">
                            ...
                            <input type="date" id="checkin" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        </div>
                        <div class="lg:col-span-1">
                            <label for="checkout" class="block text-sm font-medium mb-2">Check-out</label>
                            <input type="date" id="checkout" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        </div>
                        <div class="lg:col-span-1">
                            <label for="guests" class="block text-sm font-medium mb-2">Guests</label>
                            <select id="guests" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <select id="room-type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        ...
                        <div class="lg:col-span-1">
                            ...
                            <button type="submit" class="w-full bg-gold text-white py-2 px-4 rounded-lg hover:bg-gold-dark transition-colors font-semibold">
                                Search Rooms
                            </button>
                        </div>
                    </form>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="/placeholder.svg?height=250&width=400" alt="Standard Room" class="w-full h-64 object-cover">
                    <div class="p-6">
                ...
                <!-- Deluxe Room -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="/placeholder.svg?height=250&width=400" alt="Deluxe Room" class="w-full h-64 object-cover">
                    <div class="p-6">
                ...
                <!-- Presidential Suite -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <img src="/placeholder.svg?height=250&width=400" alt="Presidential Suite" class="w-full h-64 object-cover">
                    <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-6">
                        For over three decades, Luxe Hotel has been synonymous with exceptional hospitality and unparalleled luxury.
                        Our commitment to excellence has made us a preferred destination for discerning travelers from around the world.
                    </p>
                    <p class="text-lg text-gray-600 mb-8">
                        From our elegantly appointed rooms to our world-class amenities, every detail has been carefully crafted
                        to ensure your stay exceeds expectations. Experience the perfect blend of comfort, sophistication, and personalized service.
                    </p>
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">123 Luxury Avenue<br>Downtown District<br>New York, NY 10001</p>
                            </div>
                        </div>
                    ...
                    <form class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="first-name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                            </div>
                            <div>
                                <label for="last-name" class="block text-sm font-medium text-gray-700 mb-2">Last Name</label>
                                <input type="text" id="last-name" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                            </div>
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" id="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        </div>
                        <div>
                            <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Subject</label>
                            <input type="text" id="subject" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent">
                        </div>
                        <div>
                            <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                            <textarea id="message" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gold focus:border-transparent"></textarea>
                        </div>
                        <button type="submit" class="w-full bg-gold text-white py-3 px-6 rounded-lg hover:bg-gold-dark transition-colors font-semibold">
                            Send Message
                        </button>
                    </form>
                </div>
